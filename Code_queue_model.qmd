...
-   5 patients per day arrive with the **very** **mild** level of stroke. Thus, the $\lambda$ = 5/day or 5/24
...
library(utilities)
QUEUE <- queue(arrive = ARRIVE4, use.full = use_time4,
                n = 1)
