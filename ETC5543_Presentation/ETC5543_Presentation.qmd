...
<span> The auxiliary functions computed the patients inter-arrival times, assigned stroke categories based on the stroke level probabilities to patients, and calculated the length of stay of the patients based on the assigned stroke categories. </span>
