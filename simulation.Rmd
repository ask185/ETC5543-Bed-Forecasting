...
# #                               num_beds= 30)
# 
# stroke_sim_10 <- stroke_simulation(total_patients= total_patients, 
#                                    arrival_rate= arrival_rate, 
#                               bed_occupation_time = bed_occupation_time, 
#                               stroke_level_prob= stroke_level_prob, 
#                               num_beds= 10)
# 
# # long_format_data <- stroke_sim_25 %>%
# #   gather(key = "variable", value = "value", starts_with("queue"))
# 
# stroke_sim_10 <- data.frame(stroke_sim_25)
# 
...
#   mutate(ci_utilization_mean_lower = utilization_mean - qt(0.975, num_simulations - 1) * utilization_mean_sd / sqrt(num_simulations),
#          ci_utilization_mean_upper = utilization_mean + qt(0.975, num_simulations - 1) * utilization_mean_sd / sqrt(num_simulations))




#colnames(metrics_summary)
...
# Example of simple plot: changes in utilization for different number of beds
library(ggplot2)
ggplot(results[["arrival_rate_1.2"]], aes(x=num_beds, y=utilization)) +
  geom_line() +
  xlab("Number of Beds") +
  ylab("Utilization") +
  ggtitle("Sensitivity of Utilization to Number of Beds")
