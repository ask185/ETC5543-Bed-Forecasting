...
total_patients <- 1000 # assuming there are 1000 
...
bed_occupation_time <- list(
  ...
  severe_nursing = c(3,21),  # patients sent to nursing center may stay up to 2 weeks
  severe = c(1,21) # die
)
...
# and the bed is now available for other patients).
  ...
  return(list(beds = beds, queue = queue))
}

stroke_simulation(total_patients = 2000,arrival_rate = 6, 
