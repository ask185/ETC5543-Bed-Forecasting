...
```
The plots shows us the mean length of stay for each category of stroke in the arrival data sets.
```{r}
...
stroke_sim_20 <- data.frame(stroke_sim_20)
library(ggplot2)
stroke_sim_20$length_of_stay <- as.numeric(stroke_sim_20$length_of_stay)
ggplot(stroke_sim_20, aes(x = length_of_stay)) +
