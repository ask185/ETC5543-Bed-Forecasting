...
I have developed a web-based app such that policy makers and clinicians can use it as policy support tool to estimate the number of bed needed in their hospitals. (it can be found [here](https://aryan-sultan-1120.shinyapps.io/App_for_stroke_simulation/))
...
The stroke categories were assigned based on the stroke level probabilities. The total annual patient load considered for this analysis was \~ $350$. The performance metrics were computed for $350$ yearly patients as well as for the an estimated annual load of 2500 patients for the future. (The results for 2500 patient influx can be viewed on the web-app; in this report the initial annual patient load as well as the initial-provision of beds are considered and discussed.)
