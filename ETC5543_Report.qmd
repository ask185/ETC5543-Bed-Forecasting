...
In Figure 3, the distribution of the patients in each category follows the stroke category probabilities and the highest number of patients -- 691 -- were assigned to the *mild* category of stroke --refer to Table 1 for information on the categories and the respective probabilities.
...
I ran the simulation for $120$ times for $31$ different number of beds (from $20-50$) and $2000$ patients.
