...
[^7]: I acknowledge the use of \[1\] ChatGPT (<https://chat.openai.com/>) to \[2\] help structure my code in such a way that the simulation and computation of metrics could be applied across the range of beds and number of simulations.
