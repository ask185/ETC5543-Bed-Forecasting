...
In this project, *Discrete Event Simulation* has been employed todevelop a queuing system that accurately captures the intricate complexity and inherent variability of a stroke ward. This model takes into account the stochastic nature of the patient arrivals, stroke severity levels, and length of stay to enabling a comprehensive analysis of the hospital ward's performance under different scenarios. To ensure the model's accuracy I incorporated key parameters such as the arrival rates, bed occupation times and the stroke level probabilities which were acquired from a combination of historical data, hospital statistics and relevant literature. @green2011queueing By effectively representing the complex interaction between these factors, this DES model is meant to provide valuable insights into the stroke ward's operations at the Monash Hospital.

**Significance and Contributions**:

The analysis and methodology employed in this study offer significant contributions and insight into the operations of the stroke care units in hospitals. DES model used in this project provides a realistic and flexible representation of the queue systems at the hospitals by accurately accounting for the complexity and variability of a stroke ward, enabling users to generate performance metrics such as the percent of patients waiting at the given number of beds in the unit for a specific number of patients, or the utilization capacity for a specific number of beds in the care unit under range different scenarios. This simulation model is meant to be used as a support tool for decision-making process regarding the bed allocation in the hospital.
