...
The analysis and methodology employed in this study offer significant contributions and insight into the operations of the stroke care units within hospitals. DES model utilized in this project provides a realistic and adaptable representation of the queue systems at the hospitals by accurately capturing the complexity and variability of a stroke ward. This enables users to generate performance metrics, such as the percent of patients waiting at the given number of beds in the unit for a specific patient population, or the utilization capacity for a paritcular number of beds in the care unit under variety of scenarios. This simulation model is designed to be used as a support tool for hospital adminsitartors when determining optimal bed allocation and resource management, ultimately enhancing patient care and outcomes.
