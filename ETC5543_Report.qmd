...
Healthcare systems are under continual pressure to provide accessible and effective health services to patients, therefore, the decisions regarding adequate provision of services to the patients is vital for optimal care of patients in the hospital. Hence, hospital capacity planning has become an important issue around the world due to the growing demand for hospital care and an increasing cost of inpatient care. Key metrics such as bed capacity and associated indices such as bed occupancy and the ratio of beds to population are used to determine the availability of inpatient care [@Ravaghi2020]. The number of beds in a hospital can be thought of as a capital stock, which is influenced by the performance of medical staff and equipment [@healthGlance2017] [@liu2012] . A shortage of available beds is the primary cause of delays in emergency admission and surgery cancellations, and early patient discharge [@rechel2010hospital]. On the other hand, under utilization of beds in the hospitals lead to additional costs for the hospital, however, according to "*Hospital capacity planning: From measuring stocks to modelling flows."* published in the *Medical Journal of Australia (2010)* @martin_storey_2010, 85% bed occupancy rate is a reasonable target for hospitals, although this may need to change depending on the facility and time periods. Effective use of hospital resources, including bed capacity, necessitates hospital capacity planning in the short to long term.

In order to come up with better policy designs for healthcare industry, researchers, policy makers and other professionals studying the healthcare systems have made use of the simulation based modeling to replicate the real life scenarios in the healthcare units and hospitals to improve the policy framework. For the purpose of this project at the *Monash Medical Research institute*, I have used the simulation modelling to represent a queuing system within a hospital setting. The main objective of this simulation was to simulate the flow of patients as they arrive, wait in line (queue) for an available bed, receive treatment, and exit the resource (making the bed available for the next patient in the queue to use).
