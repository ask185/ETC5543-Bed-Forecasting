...
Across the world healthcare systems are under continual pressure to provide accessible and effective health services to patients due to growing population; consequently, the decision-making regarding the adequate provision of services to the patients is crucial for optimal patient care in hospitals, therefore, hospital capacity planning has become critical for improved patient outcome.
...
In order to simulate the patient inflow, stay and discharge I created the `stroke_simulation` function, which uses the previously created functions to achieve the intended results.[^3]
