...
Having defined these functions, the next step is check the distribution of the length of stay of the patients in our simulation model and have a look at the data.
